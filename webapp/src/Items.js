	  ...
	  return(
          ...
          <br></br>
            <form className={classes.root} noValidate autoComplete="off">
              <Input placeholder="Item ID" inputProps={{ 'aria-label': 'description' }} value={this.state.id} onChange={this.handleIDChange}/>
            </form>
          </Box>
          <Box p={1}>
          <br></br>
...
}  export default withStyles( useStyles ) (ItemLookup);
