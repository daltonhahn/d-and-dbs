...
class ClassLookup extends Component {
	constructor(props) {
		super(props);
		this.state = {
			spell_type: '',
	  ...
	  return(
          ...
          <br></br>
            <form className={classes.root} noValidate autoComplete="off">
              <Input placeholder="Class ID" inputProps={{ 'aria-label': 'description' }} value={this.state.id} onChange={this.handleIDChange}/>
            </form>
          </Box>
    <Box p={3}>
...
}  export default withStyles( useStyles ) (ClassLookup);
